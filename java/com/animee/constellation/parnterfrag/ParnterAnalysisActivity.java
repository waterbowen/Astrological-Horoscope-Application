...
public class ParnterAnalysisActivity extends AppCompatActivity implements LoadDataAsyncTask.OnGetNetDataListener, View.OnClickListener {
    ...
    public void onSuccess(String json) {
        if (!TextUtils.isEmpty(json)) {
            ...
            pfTv.setText("Paired ratins: "+resultBean.getZhishu()+"  "+resultBean.getJieguo());
            bzTv.setText("Constellation: "+resultBean.getBizhong());
            jxTv.setText("Analysis:\n\n"+resultBean.getLianai());
            zyTv.setText("Notification:\n\n"+resultBean.getZhuyi());
        }
    ...
    private void initView() {
        ...
        titleTv.setText("Paired details");
    }
